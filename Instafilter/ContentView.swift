...
//  Instafilter
//
//  Created by Margarita Mayer on 22/01/24.
//
...
//    @State private var currentFilter = CIFilter.comicEffect()
    ...
    var body: some View {
        NavigationStack {
            ...
            .confirmationDialog("Showing filtes", isPresented: $showingFilters) {
